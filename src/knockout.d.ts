// Note: this is a custom combination of .d.ts files for both knockout and knockout-postbox
...
// its such a small amount of work to add support for knockout punches, so I added it here.  This probably belongs in a seperate file
